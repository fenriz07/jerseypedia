...
include(JERSEY_DIR . 'inc/libs/facebook-sdk/autoload.php');
/*
...
/**
 * Class JerseyFB
 * TODO: CLASS NO PROBADA DEBIDO A QUE LA CONEXION A FB DEBE HACERSE POR HTTPS
 * TODO: Pendiente la modificaicon de la clase
 * TODO: Cuando se pueda probar bien se continua con el desarrollo de la funcionalidad.
 */
class JerseyFB
{
    /**
     ...
     * @var string
     */
    private $app_id = '183192645636105';
    /**
     * Facebook APP Secret
     *
     * @var string
     */
    private $app_secret = '68399ed05fbe7a512a43ad92a5c1bcb8';
    /**
     * Callback URL used by the API
     *
     * @var string
     */
    private $callback_url = 'http://jerseylocal.com/wp-admin/admin-ajax.php?action=alka_facebook';
    /**
    ...
    private function createUser()
    {
        ...
        // Creating our user
        $user_id = wp_create_user($username, wp_generate_password(), $fb_user['email']);
        ...
        if (is_wp_error($user_id)) {
            // Report our errors
            $_SESSION['alka_facebook_message'] = $user_id->get_error_message();
            // Redirect
            header("Location: ".$this->redirect_url, true);
            die();
        }
        ...
        update_user_meta($user_id, 'jersey_facebook_id', $fb_user['id']);
        // Log the user ?
